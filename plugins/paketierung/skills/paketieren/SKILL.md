...
- `powershell -File tools\echter-test.ps1 -SetupInf "<Pfad>\Install\setup.inf"`; das Skript erhöht sich selbst (UAC durch den Nutzer), läuft Installation, erneuten Aufruf und Deinstallation, beobachtet neue Prozesse und prüft Rückstände in beiden Registry-Ansichten, im Programmordner, bei geplanten Aufgaben und Verknüpfungen. Log und Testbericht landen im Versionsordner.
